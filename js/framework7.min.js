...
window.Dom7 = function () {
    ...
    function r(e, a) {
        if ("object" == typeof e && a)if (Array.isArray(e) || e instanceof C) {
            for (var t = 0; t < e.length; t += 1)if (!1 === a(t, e[t]))return
                    ...
                    m || (m = !0, a.begin && a.begin(r)), null === p && (p = s), a.progress && a.progress(r, Math.max(Math.min((s - p) / a.duration, 1), 0), p + a.duration - s < 0 ? 0 : p + a.duration - s, p), i.forEach(function (t) {
                        ...
                        o || r.done || Object.keys(e).forEach(function (t) {
                            if (!o && !r.done) {
                                ...
                                var l = r[t], m = l.initialValue, f = l.finalValue, g = l.unit;
    ...
    function f(a) {
        ...
        var l = a.url.indexOf("?") >= 0 ? "&" : "?", p = a.method.toUpperCase();
        ...
        if ("json" === a.dataType && a.url.indexOf("callback=") >= 0) {
            var c, m = "f7jsonp_" + (Date.now() + (z += 1)), u = a.url.split("callback="), h = u[0] + "callback=" + m;
            if (u[1].indexOf("&") >= 0) {
            ...
            return g.type = "text/javascript", g.onerror = function () {
                clearTimeout(c), t(void 0, void 0, "error", null, "scripterror"), t("ajaxComplete ajax:complete", {scripterror: !0}, "complete", null, "scripterror")
        ...
        var b = null;
        if (("POST" === p || "PUT" === p || "PATCH" === p) && a.data)if (a.processData) {
            var w = [ArrayBuffer, Blob, Document, FormData];
            if (w.indexOf(a.data.constructor) >= 0)b = a.data; else {
        ...
        return v.onload = function () {
            if (k && clearTimeout(k), v.status >= 200 && v.status < 300 || 0 === v.status) {
                ...
                if ("json" === a.dataType)try {
                    e = JSON.parse(v.responseText), t("ajaxSuccess ajax:success", {xhr: v}, "success", e, v.status, v)
                } catch (e) {
                    t("ajaxError ajax:error", {xhr: v, parseerror: !0}, "error", v, "parseerror")
                } else e = "text" === v.responseType || "" === v.responseType ? v.responseText : v.response, t("ajaxSuccess ajax:success", {xhr: v}, "success", e, v.status, v)
            } else t("ajaxError ajax:error", {xhr: v}, "error", v, v.status);
            a.statusCode && (o.statusCode && o.statusCode[v.status] && o.statusCode[v.status](v), a.statusCode[v.status] && a.statusCode[v.status](v)), t("ajaxComplete ajax:complete", {xhr: v}, "complete", v, v.status)
        }, v.onerror = function () {
            k && clearTimeout(k), t("ajaxError ajax:error", {xhr: v}, "error", v, v.status), t("ajaxComplete ajax:complete", {
                xhr: v,
                error: !0
            }, "complete", v, "error")
        }, t("ajaxStart ajax:start", {xhr: v}, "start", v), t(void 0, void 0, "beforeSend", v), a.timeout > 0 && (v.onabort = function () {
            k && clearTimeout(k)
        }, k = setTimeout(function () {
            v.abort(), t("ajaxError ajax:error", {
                xhr: v,
                timeout: !0
            }, "error", v, "timeout"), t("ajaxComplete ajax:complete", {xhr: v, timeout: !0}, "complete", v, "timeout")
    ...
    for (var y = [{base: "A", letters: "AⒶＡÀÁÂẦẤẪẨÃĀĂẰẮẴẲȦǠÄǞẢÅǺǍȀȂẠẬẶḀĄȺⱯ"}, {base: "AA", letters: "Ꜳ"}, {
        base: "AE",
        letters: "ÆǼǢ"
    ...
    }], x = {}, T = 0; T < y.length; T += 1)for (var k = y[T].letters, P = 0; P < k.length; P += 1)x[k[P]] = y[T].base;
    for (var S = {
        __utils: !0,
        parseUrlQuery: a,
        parseQuery: a,
        ...
        addClass: function (e) {
            ...
            for (var r = a[0].split(" "), n = a[1], i = 0; i < r.length; i += 1)for (var s = 0; s < this.length; s += 1) {
                var o = void 0;
                try {
                    o = new window.CustomEvent(r[i], {detail: n, bubbles: !0, cancelable: !0})
                } catch (e) {
            ...
            var a = this;
            if (!e)return this;
            for (var t = 0; t < this.length; t += 1)if (!1 === e.call(a[t], a[t], t))return a;
            return this
        }, filter: function (e) {
            ...
            for (var r, n = 0; n < a.length; n += 1) {
                ...
                } else if (r instanceof C)for (var o = 0; o < r.length; o += 1)e[i].appendChild(r[o]); else e[i].appendChild(r)
            }
            return this
        }, appendTo: function (a) {
            ...
            } else if (e instanceof C)for (t = 0; t < e.length; t += 1)r[a].insertBefore(e[t], r[a].childNodes[0]); else r[a].insertBefore(e, r[a].childNodes[0]);
            return this
            ...
            for (var t = this, r = [], i = 0; i < this.length; i += 1)for (var s = t[i].parentNode; s;)a ? e(s).is(a) && r.push(s) : r.push(s), s = s.parentNode;
            return e(n(r))
        }, closest: function (e) {
            var a = this;
            ...
            for (var t = this, r = [], i = 0; i < this.length; i += 1)for (var s = t[i].childNodes, o = 0; o < s.length; o += 1)a ? 1 === s[o].nodeType && e(s[o]).is(a) && r.push(s[o]) : 1 === s[o].nodeType && r.push(s[o]);
            return new C(n(r))
        }, remove: function () {
    ...
    var O = {
        scrollTo: function () {
            for (var e = [], a = arguments.length; a--;)e[a] = arguments[a];
            var t = e[0], r = e[1], n = e[2], i = e[3], s = e[4];
            ...
            return void 0 === i && (i = "swing"), this.each(function () {
                function e(t) {
                    ...
                    var r, p = Math.max(Math.min((t - b) / n, 1), 0), d = "linear" === i ? p : .5 - Math.cos(p * Math.PI) / 2;
                ...
                var a, o, p, d, c, m, u, h, f = this, g = r > 0 || 0 === r, v = t > 0 || 0 === t;
    ...
    }, L = {animate: m, stop: u}, D = {}, z = 0, B = {__utils: !0, ajaxSetup: h, ajax: f, get: v, post: b, getJSON: w};
    ...
    function r(e) {
        ...
        for (t = 0; t < n.length; t += 1) {
            var s = n[t], o = void 0, l = void 0;
            if (0 === t)i.push(s); else if (0 === s.indexOf('"') || 0 === s.indexOf("'"))if (o = 0 === s.indexOf('"') ? d : p, l = 0 === s.indexOf('"') ? '"' : "'", 2 === s.match(o).length)i.push(s); else {
                for (a = 0, r = t + 1; r < n.length; r += 1)if (s += " " + n[r], n[r].indexOf(l) >= 0) {
                    a = r, i.push(s);
                    break
                }
                a && (t = a)
                ...
                if (o || (o = 0 === u.indexOf('"') ? d : p, l = 0 === u.indexOf('"') ? '"' : "'"), 2 !== u.match(o).length) {
                    for (a = 0, r = t + 1; r < n.length; r += 1)if (u += " " + n[r], n[r].indexOf(l) >= 0) {
                        a = r;
                        break
                    }
                    a && (t = a)
    ...
    function s(e, a) {
        return e.split(/([+ -*^])/g).map(function (e) {
            ...
            var t = e.split("../").length - 1, r = t > a.length ? a[a.length - 1] : a[t - 1], n = r;
    ...
    var p = new RegExp("'", "g"), d = new RegExp('"', "g"), c = function (e) {
        function a(e, a, t) {
            void 0 === t && (t = "data_1");
            var r, n, i = a, s = 0;
            ...
            for (h = 0; h < d.length; h += 1) {
                ...
                if ("plain" !== f.type) {
                    ...
                    if ("variable" === f.type && (g = a(f.contextName, c, m), u += "r += c(" + g + ", " + c + ");"), "helper" === f.type) {
                        ...
                        if (f.helperName in i.helpers)v = t(f.contextName, c, m), u += "r += (Template7.helpers." + f.helperName + ").call(" + c + ", " + (v && v + ", ") + "{hash:" + JSON.stringify(f.hash) + ", data: " + m + " || {}, fn: " + o(f, s + 1) + ", inverse: " + p(f, s + 1) + ", root: root, parents: " + b + "});"; else {
    ...
    return c.prototype = {
        options: {}, partials: {}, helpers: {
            _partial: function (e, a) {
                ...
                return "index first last key".split(" ").forEach(function (e) {
                    if (void 0 !== r[e]) {
                        var a = new RegExp("this.@" + e, "g"), t = new RegExp("@" + e, "g");
        ...
        c.prototype.partials[e] = {template: a}
    ...
    window.Framework7 = function (e) {
        ...
        var o = function (e, a) {
            ...
            var v, b, w, C, y, x, T, k, P, S, M, I, E = !1, O = !1, L = {}, D = [], z = [], B = !0, N = [], A = [];
            if (o.handleTouchStart = function (e) {
                    ...
                    if (E = !1, O = !1, 0 === w)return i([D[0], z[0]]).transform(""), void(P && (y.transform("").css({opacity: ""}), x.transform("").css({opacity: ""}), T && T.length > 0 && T.transform(""), k && T.length > 0 && k.transform("")));
                    ...
                    var n = {activePage: D[0], previousPage: z[0], activeNavbar: N[0], previousNavbar: A[0]};
                    if (t) {
        ...
        r.triggerPageCallbacks = function (e, a, t) {
            ...
            if (e.params.uniqueHistory) {
                var L = e.history, D = h;
                if (e.params.uniqueHistoryIgnoreGetParameters)for (L = [], D = h.split("?")[0], l = 0; l < e.history.length; l++)L.push(e.history[l].split("?")[0]);
        ...
        r.modalStack = [], r.modalStackClearQueue = function () {
            ...
            var t = e.hasClass("modal"), n = e.hasClass("popover"), s = e.hasClass("popup"), o = e.hasClass("login-screen"), l = e.hasClass("picker-modal"), p = e.hasClass("actions-modal"), d = "modal";
        ...
        r.messages = function (e, a) {
            ...
            function t(e) {
                if (s) {
                    ...
                    if (h.length > 0)for (O = v / f, v > f && (v = f + Math.pow(v - f, .8), T.length > 0 && (P = !0)), n = 0; n < C.length; n++)void 0 === C[n]._buttonOffset && (C[n]._buttonOffset = f - C[n].offsetLeft - C[n].offsetWidth), p = C[n]._buttonOffset, L = i(C[n]),
                    T.length > 0 && L.hasClass("swipeout-overswipe") && (L.css({left: (P ? p : 0) + "px"}), P ? L.addClass("swipeout-overswipe-active") : L.removeClass("swipeout-overswipe-active")), C.length > 1 && L.css("z-index", C.length - n), L.transform("translate3d(" + (v + p * (1 - Math.min(O, 1))) + "px,0,0)");
            ...
            if (e = i(e), 0 !== e.length) {
                ...
                if (0 !== p.length) {
                    ...
                    if (!(T.disabled || e.hasClass("disabled") || k.hasClass("disabled"))) {
                        ...
                        var X = r._compiledTemplates.smartSelectItem, G = "";
                        if (!w)for (var j = 0; j < H.length; j++)G += X(H[j]);
                        var _, U, J = "", Q = "", K = "", Z = "";
                        ...
                        var re, ne, ie = '<form class="searchbar searchbar-init" data-search-list=".smart-select-list-' + R + '" data-search-in=".item-title"><div class="searchbar-input"><input type="search" placeholder="' + $ + '"><a href="#" class="searchbar-clear"></a></div>' + (y ? "" : '<a href="#" class="searchbar-cancel">' + ee + "</a>") + '</form><div class="searchbar-overlay"></div>', se = ("picker" !== d && "through" === U ? _ : "") + '<div class="pages">  <div data-page="' + ae + '" data-select-name="' + F + '" class="page smart-select-page ' + Q + " " + K + " " + Z + '">' + ("picker" !== d && "fixed" === U ? _ : "") + (te ? ie : "") + '    <div class="page-content">' + ("picker" !== d && "static" === U ? _ : "") + '      <div class="list-block ' + (w ? "virtual-list" : "") + " smart-select-list-" + R + " " + (g ? "theme-" + g : "") + '">        <ul>' + (w ? "" : G) + "        </ul>      </div>    </div>  </div></div>";
        ...
        var b = function (e) {
            ...
            return p.setValue = function (e, a) {
                ...
                } else for (a = 0; a < p.cols.length; a++)p.cols[a].divider || (r.push(p.cols[a].value), n.push(p.cols[a].displayValue));
        ...
        r.addNotification = function (e) {
            ...
            e = i(e);
            var r = e.find(".data-table-header"), n = e.find(".data-table-header-selected");
        ...
        if (void 0 !== g && "undefined" != typeof Dom7 && (g = Dom7), (void 0 !== g || (g = "undefined" == typeof Dom7 ? window.Dom7 || window.Zepto || window.jQuery : Dom7)) && (f.$ = g, f.currentBreakpoint = void 0, f.getActiveBreakpoint = function () {
            ...
            f.onTouchStart = function (e) {
                ...
                if (e.originalEvent && (e = e.originalEvent), !L || "mousemove" !== e.type) {
                    ...
                    if (L && f.params.touchReleaseOnEdges && !f.params.loop)if (f.isHorizontal()) {
